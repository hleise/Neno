...
SimplybookWidget.prototype.displayIframe = function () {
    ...
    bookingWidget.innerHTML = '<iframe style="position: relative; height: 100vh; margin-top: 50px; " width="100%" border="0" frameborder="0" scrolling="no" src=" //vivoapps.simplybook.me/v2/#book"></iframe>';
